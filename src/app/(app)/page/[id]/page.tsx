            ...
            <div style={{ flex: 1, marginLeft: 'var(--sidebar-width)', minHeight: '100vh' }}>
                ...
                <div style={{
                    ...
                    <div style={{ marginBottom: '4px' }}>
                        {page.icon && (
                            <div style={{ fontSize: '72px', lineHeight: 1, marginBottom: '8px', cursor: 'pointer' }}>
                                {page.icon}
                            </div>
                        )}

                        {/* Controls */}
                        <div className="page-controls" style={{ display: 'flex', gap: '8px', marginBottom: '12px' }}>
                            {!page.icon && (
                                <button style={{ display: 'flex', alignItems: 'center', gap: '4px', padding: '4px 8px', borderRadius: 'var(--radius-sm)', fontSize: '13px', color: 'var(--text-tertiary)', cursor: 'pointer', background: 'none', border: 'none' }} className="page-control-btn">
                                    <Smile size={14} />
                                    Add icon
                                </button>
                            )}
                        ...
                        <div style={{ marginTop: '24px', borderTop: '1px solid var(--divider)', paddingTop: '16px' }}>
                            ...
                            {page.children.map(child => (
                                <div
                                    ...
                                    style={{ display: 'flex', alignItems: 'center', gap: '8px', padding: '6px 8px', borderRadius: 'var(--radius-sm)', cursor: 'pointer', fontSize: '14px', color: 'var(--text-secondary)', marginBottom: '2px', transition: 'background 0.08s' }}
